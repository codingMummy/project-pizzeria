const dataSource = {}; // eslint-disable-line no-unused-vars; definicja produktów - jest to obiekt
...
dataSource.products = {
  ...
  pizza: {
    ...
    images: [
      // class - (oprócz activ) pierwszy z nich to klucz parametru, a drugi to klucz opcji
